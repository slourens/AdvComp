...
ggplot(data = troops, aes(x = long, y = lat)) + geom_path(
  ...
  lineend = "round") + geom_text(aes(label = city, y = lat + 0.06), size = 3, 
  data = cities) + geom_point(aes(x = long, y = lat), 
...
ggplot(data = troops, aes(x = long, y = lat)) + geom_path(
  aes(size = survivors, colour = direction, group = group), 
  lineend = "round") + geom_text(aes(label = city, y = lat + 0.06), size = 3, data = cities) + 
